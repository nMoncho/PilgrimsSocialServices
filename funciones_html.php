...
/**
 * @return boolean true si el request es un post
 */
function is_post() {
...
/**
 * @return boolean true si el request es un get
 */
function is_get() {
...
function cargar_usuario_sesion($nombre_usuario, $password) {
  session_start();
  $_SESSION['principal'] = array("username" => $nombre_usuario
          , "credentials" => $password, "login_date" => time());
}
